...
const translations: Record<Locale, Record<string, string>> = {
  lo: {
    ...
    logging_in_btn: "ກຳລັງເຂົ້າສູ່ລະບົບ...",
    no_account_label: "ຍັງບໍ່ມີບັນຊີ?",
    register_link: "ລົງທະບຽນ",
    login_error_invalid: "ເບີໂທ ຫຼື ລະຫັດຜ່ານບໍ່ຖືກຕ້ອງ",
    login_error_generic: "ເກີດຂໍ້ຜິດພາດ, ກະລຸນາລອງໃໝ່",
    register_title: "ລົງທະບຽນ",
    full_name_label: "ຊື່ເຕັມ",
    full_name_placeholder: "ຊື່ ແລະ ນາມສະກຸນ",
    phone_label_with_prefix: "ເບີໂທລະສັບ +856",
    send_verification_code_btn: "ສົ່ງລະຫັດຢັ້ງຢືນ",
    verification_code_placeholder: "ລະຫັດ 6 ຕົວເລກ",
    verify_btn: "ຢັ້ງຢືນ",
    verified_phone_label: "✓ ຢັ້ງຢືນເບີໂທແລ້ວ",
    password_placeholder: "ຢ່າງໜ້ອຍ 6 ຕົວ",
    confirm_password_label: "ຢືນຢັນລະຫັດຜ່ານ",
    confirm_password_placeholder: "ປ້ອນລະຫັດຜ່ານອີກຄັ້ງ",
    address_label_full: "ທີ່ຢູ່ (ບ້ານ, ເມືອງ, ແຂວງ)",
    address_placeholder_register: "ບ້ານທົ່ງຂັນຄຳ, ເມືອງຈັນທະບູລີ, ນະຄອນຫຼວງວຽງຈັນ",
    register_btn: "ລົງທະບຽນ",
    registering_btn: "ກຳລັງລົງທະບຽນ...",
    already_has_account: "ມີບັນຊີຢູ່ແລ້ວ?",
    register_error_phone_format: "ກະລຸນາປ້ອນເບີໂທລະສັບ 9 ຕົວເລກ (20xxxxxxx)",
    register_error_verification_failed: "ບໍ່ສາມາດສົ່ງລະຫັດໄດ້, ກະລຸນາລອງໃໝ່",
    register_error_code_digits: "ລະຫັດຢັ້ງຢືນຕ້ອງມີ 6 ຕົວເລກ",
    register_error_verify_first: "ກະລຸນາຢັ້ງຢືນເບີໂທກ່ອນ",
    register_error_password_mismatch: "ລະຫັດຜ່ານບໍ່ກົງກັນ",
    register_error_password_length: "ລະຫັດຜ່ານຕ້ອງມີຢ່າງໜ້ອຍ 6 ຕົວ",
    register_error_already_registered: "ເບີໂທນີ້ຖືກລົງທະບຽນແລ້ວ, ກະລຸນາເຂົ້າສູ່ລະບົບ",
    register_success_alert: "ລົງທະບຽນສຳເລັດ! ກະລຸນາເຂົ້າສູ່ລະບົບ",
    register_phone_verified_alert: "ຢັ້ງຢືນເບີໂທສຳເລັດ",
    verification_code_alert_prefix: "ລະຫັດຢັ້ງຢືນ: ",
    verification_code_alert_suffix: " (6 ໂຕເລກ)"
  },
  en: {
    cart: "Cart",
    search: "Search",
    ...
    login_error_invalid: "Incorrect phone number or password",
    login_error_generic: "An error occurred, please try again",
    register_title: "Register",
    full_name_label: "Full Name",
    full_name_placeholder: "First and last name",
    phone_label_with_prefix: "Phone Number +856",
    send_verification_code_btn: "Send Verification Code",
    verification_code_placeholder: "6-digit code",
    verify_btn: "Verify",
    verified_phone_label: "✓ Phone verified",
    password_placeholder: "At least 6 characters",
    confirm_password_label: "Confirm Password",
    confirm_password_placeholder: "Enter password again",
    address_label_full: "Address (Village, District, Province)",
    address_placeholder_register: "Thongkhankham Village, Chanthabouly District, Vientiane Capital",
    register_btn: "Register",
    registering_btn: "Registering...",
    already_has_account: "Already have an account?",
    register_error_phone_format: "Please enter a 9-digit phone number (20xxxxxxx)",
    register_error_verification_failed: "Failed to send code, please try again",
    register_error_code_digits: "Verification code must be 6 digits",
    register_error_verify_first: "Please verify phone number first",
    ...
    register_error_already_registered: "This phone number is already registered, please login",
    register_success_alert: "Registration successful! Please login",
    register_phone_verified_alert: "Phone number verified successfully",
    verification_code_alert_prefix: "Verification code: ",
    verification_code_alert_suffix: " (6 digits)"
  }
};
